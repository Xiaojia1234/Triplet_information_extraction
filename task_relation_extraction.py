...
maxlen = 128
batch_size = 64
config_path = 'D:\Amy_work_pace\PROJECTS\Deep Learning\BETR_Model\chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = 'D:\Amy_work_pace\PROJECTS\Deep Learning\BETR_Model\chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = 'D:\Amy_work_pace\PROJECTS\Deep Learning\BETR_Model\chinese_L-12_H-768_A-12/vocab.txt'
...
print(valid_data[10])
print('text:',valid_data[10]['text'])
print('spo_list:')
for i in valid_data[10]['spo_list']:
    print('subject:',i[0])
    print('predicate:',i[1])
    print('object:',i[2],'\n\n')
...
# 加载预训练模型
bert = build_transformer_model(config_path=config_path,checkpoint_path=checkpoint_path,return_keras_model=False,)
...
# 训练模型
train_model = Model(bert.model.inputs + [subject_labels, subject_ids, object_labels],[subject_preds, object_preds])
